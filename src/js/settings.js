module.exports = {
  "wizSpellList": ["CF", "CS", "DF", "EF", "FU", "ER", "ES", "FA", "FC", "MB", "SV", "WF", "WE"],
  "mageSpellList": ["BS", "CF", "CR", "FA", "FC", "RC", "RS", "SB", "SS", "SM"],
  "basicDmgFocusContext": {
    "settings": [
      {
        "id": "eye-of-decay",
        "value": "0.1",
